...
// 过滤筛选组件 模拟数据列表
export const filterDataList: Array<FilterDataList> = [
    {
        img: 'http://news.sznews.com/pic/2020-08/14/9d9c9a60-f0af-41aa-b617-683b07c87642.jpg',
        title: '嘉陵江2020年第1号洪水”在嘉陵江支流涪江形成',
        commentNum: (Math.random() * 100).toFixed(2),
        collectNum: (Math.random() * 100).toFixed(2),
        price: (Math.random() * 100).toFixed(2),
        salesNum: (Math.random() * 100).toFixed(2),
    },
    {
