...
const exportExcel = function (luckysheet: any, value: any) {
...
var setMerge = function (luckyMerge: any = {}, worksheet: any) {
...
function addborderToCell(borders: any, row_index: any, col_index: any) {
    let border: any = {}
